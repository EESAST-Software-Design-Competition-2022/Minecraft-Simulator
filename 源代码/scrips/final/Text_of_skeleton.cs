...
{
    public class Text_of_skeleton : MonoBehaviour
    {
        int line0;
        int linecount1 = 0;
        public Text texshow1;
        public GameObject object1, object2,object3;//场景内选择与两个场景接口
        int num = 0;
        string name, line;
        ...
        private void Start()
        {
            ...
            {
                numerical.c2 = 1;
                name = "/final/the_nether/c2.txt";
                line0 = 12;
                numerical.win = 0;
            }
            else if (numerical.c2 == 1)
            {
                if (numerical.fight(300))
                {
                    numerical.win = 1;
                    name= "/final/the_nether/c4.txt";
                    numerical.force += 30;
                    line0 = 12;
                    numerical.c2 = 2;
                }
        ...
        public void Text()
        {
            using (StreamReader sr = new StreamReader(Application.streamingAssetsPath + name))
            {
                ...
                if (((line = sr.ReadLine()) != null))
                {
                    ...
                    if (linecount1 > line0 && num == 0 && numerical.c2 == 1)//选择开打
                    {
                        Instantiate(object1, new Vector2(0, 0), Quaternion.identity);
                        num++;
                    }
                    else if (linecount1 > line0 && num == 0 && numerical.c2 == 2 && numerical.win == 1) //战胜
                    {
                        Instantiate(object2, new Vector2(0, 0), Quaternion.identity);
                        num++;
                    }
                    else if (linecount1 > line0 && num == 0 && numerical.c2 == 2) //未战胜
                    {
