...
{
    public class Text_of_city : MonoBehaviour
    {
        int line0;
        int linecount1 = 0;
        public Text texshow1;
        public GameObject object1, object2;//两个剧情推进窗口
        int num = 0;
        string name, line;
        ...
        private void Start()
        {
            if (numerical.c11 == 0)
            {
                name = "/final/the_end/c11.txt";
                line0 = 38;
                numerical.c11 = 1;
            }
            else if (numerical.c11 == 1)
            {
                name = "/final/the_end/c13.txt";
                line0 = 13;
                numerical.c11 = 2;
            }
        }
        public void Text()
        {
            using (StreamReader sr = new StreamReader(Application.streamingAssetsPath + name))
            {
                ...
                if (((line = sr.ReadLine()) != null))
                {
                    ...
                    if (linecount1 > line0 && num == 0 && numerical.c11 == 1)
                    {
                        Instantiate(object1, new Vector2(0, 0), Quaternion.identity);
                        num++;
                    }
                    else if (linecount1 > line0 && num == 0 && numerical.c11 == 2)
                    {
