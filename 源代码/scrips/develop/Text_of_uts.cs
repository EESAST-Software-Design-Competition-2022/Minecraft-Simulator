...
{
    public class Text_of_uts : MonoBehaviour
    {
        int line0;
        int linecount1 = 0;
        ...
        private void Start()
        {
            if (numerical.b7 == 0)
            {
                name = "/develop/under_the_sea/before.txt";
                line0 = 3;
                numerical.b7 = 1;
            }
            else
            {
                name = "/develop/under_the_sea/after.txt";
                line0 = 2;
        ...
        public void Text()
        {
            using (StreamReader sr = new StreamReader(Application.streamingAssetsPath + name))
            {
                ...
                if (((line = sr.ReadLine()) != null))
                {
                    ...
                    if (linecount1 > line0 && num == 0&&numerical.b7==1)
                    {
