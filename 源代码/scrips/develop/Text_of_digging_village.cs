...
{
    public class Text_of_digging_village: MonoBehaviour
    {
        int line0;
        int linecount1 = 0;
        ...
        private void Start()
        {
            if (numerical.b1 == 0)
            {
                name = "/develop/construct/construct_village1.txt";
                line0 = 13;
                numerical.b1 = 1;
            }
            else
            {
                name = "/develop/construct/construct_village2.txt";
                line0 = 4;
            }
        }
        public void Text()
        {
            using (StreamReader sr = new StreamReader(Application.streamingAssetsPath + name))
            {
                ...
                if (((line = sr.ReadLine()) != null))
                {
                    ...
                    if (linecount1 > line0 && num == 0 && numerical.monster == 0 )
                    {
